...
export const faqs = [
 ...
 export const _civicsFundamentalsArray=[{displayHeading:"The Money Master",pathName:"https://youtu.be/AOk3wBuQNcE?si=A7OqUWuIkBE7HoPy", subject:'', comments:[' This gives context and details on US banking history and the corruptions that has caused to be in the bankrupt state it currently is in (as of 2025).','31 CFR 800.253 US NATIONAL, 8 usc 1101 22a and b, GPO Styles section 5.23, 8 Foreign Affaires manual section 505.2 (Passport Induction9)']},
                   {displayHeading:'dflt_What\'s the big deal about the Constitution?', markers:[{timestamp:"1:52:00- history of rights and British colonizers"}], fileName:"MichaelBadnarik-ConstitutionClass.mp4", pathName:'https://youtu.be/wp-48d_jSb4?si=sdAL6u76zMhhfE_E', subject:'', comments:['Michael Badnarik - Constitution Class (Complete), Michael has run for President a few times.','We are a Republic not a Democracy.Learn  the difference and the benefits of the rights of the republic verse the priveledges of a democracy.']},
                   {displayHeading:"Rights of private Citizens (state) vs Priveledges of US Citizens (Federal)", pathName:'', fileName:"ExLawEnforcementOfficerRichardMcDonaldonStateCitizenshipJune_17_2005.mp4", subject:'', comments:['A resident is an alien in relation to the state??? So many essential keys to understanding how the "System" works...  ','Jones vs Temmer 829 Fed Supp 1226  1993, Cal Gov code Section 242, K. Tashiro vs Jordan 256 Pacific 545 (CA Supreme Court Case), Crossey Vs Board 221 Atlantic 2nd 431 1966 ,Roberts vs Robert 81 Caleb 2nd 871 (marriage contracts), (Inray Johnson  Estate 73 specific 424 [31:15])... ']},
                  ];

 export const _moneyAndBankingArray=[{displayHeading:"US Economic Fraud in a Nutshell",fileName:"AmericanEconomics_MikeAdams.mp4", subject:'', comments:['A very nicely interwoven summary of the United States Foreign and Domestic economic policy...','']},
                                     {displayHeading:"The Money Master",fileName:"TheMoneyMasters.mp4",pathName:'', subject:'', comments:[' This gives context and details on US banking history and the corruptions that has caused to be in the bankrupt state it currently is in (as of 2025).','31 CFR 800.253 US NATIONAL, 8 usc 1101 22a and b, GPO Styles section 5.23, 8 Foreign Affaires manual section 505.2 (Passport Induction9)']},
  ];
...
const NJINGAWARRIORQUEEN_URL = 'https://drive.proton.me/urls/DXTPB31TPM#MpMeoTOUvbGS';
  const _njingaArray=[{displayHeading:"Nzinga From Historical Context", pathName:NJINGAHISTORICALCONTECT, subject:'', comments:['The Legacy of Queen Njinga/Nzinga From Historical Context','']},   
                           {displayHeading:"Njinga Warrior Queen", pathName:NJINGAWARRIORQUEEN_URL, subject:'', comments:['Lecture on the Diplomacy of Ngolo Njinga Mbande','']},];
...
//  https://eada.lib.umd.edu/ https://press-pubs.uchicago.edu/founders/
 ...
 export const references = [
    ...
    { id: 2, subcategory:'religious', category:'history', type:'book', title: "Book of Yahweh", subtitle:'Fragments from the Primitive Document in Seven Early Books of the Old Testament',  relevance:`This collection of the fragments of the primitive document is reverently dedicated to the memory of the great unknown poet prophet, to whom both Judaism and Christianity are indebted for their first Bible.`, 
              authors:['An Unknown Genius of the Ninth Century, B.C'] ,  description:'', url :'https://drive.proton.me/urls/YKKJG0DMZG#7t9j3z3kW6lq', path:'/books/history/bookofyahwehthey00mans.pdf', copyright:'1922' },
    { id: 3, category:'history', type:'book', title: "THE LAST OF THE TASMANIANS.", subtitle:'The Black War of Dan Diemans Land',  relevance:'Europe meets Australia and... well...',   authors:['James Bonwick'] ,  description:'',teraboxurl:'https://1024terabox.com/s/15zP0jT6Lj9elWMCWByECaA', path:'/books/history/europeancolonization/lasttasmanianso_jamesbonwick.pdf' , url:'https://drive.proton.me/urls/7SFCEW2PZ8#fFxV2aHazlJ8'}, 
    ...
    { id: 5,   authors:'Fazıla Derya Agis', type:'document', category:'history', title:'Learning about a Woman Queen in Africa', subtitle:'Njinga (1583-1663) as an Ecological Human Rights Defender and a Sister Against Turbulent Times of Racism and War: An Ecolinguistic Study', protonurl:'https://drive.proton.me/urls/0GEYMQSWD0#Opu2P0740EFu',  path:'/books/history/Africa_Njinga_1583.pdf'},
    { id: 6,   authors:'Vulgur Society Podcast', type:'audio', category:'history', title:'Njinga of Ndongo and Matamba: Part Two', subtitle:'Podcast ', url:'https://drive.proton.me/urls/0GEYMQSWD0#Opu2P0740EFu,' , path:'/books/history/Africa_Njinga_1583.pdf'},
    ...
    { id: 8,   authors:'Linda M. Heywood', type:'video', category:'history', title:'Njinga of Angola', subtitle:`Africa's Warrior Queen`,  iconurl:'images/imagenotavailable.jpeg', relevance:'Njunga\'s masterful diplomacy', protonurl:'https://drive.proton.me/urls/DXTPB31TPM#MpMeoTOUvbGS',url:'https://drive.proton.me/urls/DXTPB31TPM#MpMeoTOUvbGS', path:'videos/NjingaWarriorQueen.mp4'},
    ...
    { id: 10, subcategory:'contracts', category:'civics', type:'book', title: "Contracts", subtitle:'Examples & Explanations',  relevance:'',   authors:['Brian A. Blum'] ,  description:'',  url:'https://drive.proton.me/urls/MY7Z2GZEPG#J5UKp0ru4rgP', path:'books/civics/contracts/contractsExamplesAndExplanations.pdf' }, 
    ...
    { id: 14, subcategory:'', category:'civics', type:'book', title: "Cooperative Federalism", subtitle:'',  relevance:'',   authors:['Gerald Brown, Ed.D'] ,  description:'', protonurl:'https://drive.proton.me/urls/P7QWKQQ2EC#l2ckHE0GZs6u', url:'https://drive.proton.me/urls/P7QWKQQ2EC#l2ckHE0GZs6u',path:'books/civics/contracts/Cooperative_Federalism.pdf'}, 
    { id: 15, subcategory:'race', category:'civics', type:'book', title: "THE LEGAL POLITICS OF HUBERT H. HARRISON", subtitle:':EXCAVATING A LOST LEGACY',  relevance:'melanated but forced to be white',   authors:['Ravi Malhotra'] ,  description:'',  url:'https://drive.proton.me/urls/269T8T1JDM#y1urImew4uAg', protonurl:'https://drive.proton.me/urls/269T8T1JDM#y1urImew4uAg', path:'books/civics/yellow_by_law.pdf'}, 
    { id: 16, subcategory:'race', category:'civics', type:'book', title: "Yellow By Law", subtitle:'',  relevance:'',   authors:['Ravi Malhotra'] ,  description:'', path:'/books/civics/yellow_by_law.pdf', url:'https://drive.proton.me/urls/MJR2HWB4XM#UAyAwnDdhIb7'}, 
    { id: 17, subcategory:'wisdom', category:'esotoric', type:'book', title: "Truth", subtitle:'',  relevance:'',   authors:['Swami Paramhangsa Sohom'] ,  description:'', url:'https://drive.proton.me/urls/AR8Q81XEC8#V494pc4GBKgN', path:'/books/esoteric/vedic/truth-sohom-fulltext.pdf'},
