...
//  https://eada.lib.umd.edu/ https://press-pubs.uchicago.edu/founders/
 ...
 export const references = [
    { id: 1, category:'history', type:'book',  title: `Africa versus America`, subtitle:'La Fuerza de la Paradigma', iconurl:'/books/africa_versus_america.pdf' , relevance:AvAautobio,   authors:['Luisa Isabel Álvarez de Toledo, Duquesa de Medina Sidonia'] ,  description:'', url:'/books/history/africa_versus_america_orig.pdf' , mentionedBy:{mentioner:'Sabir Bey'} },
    { id: 2, subcategory:'religious', category:'history', type:'book', title: "Book of Yahweh", subtitle:'Fragments from the Primitive Document in Seven Early Books of the Old Testament',  relevance:`This collection of the fragments of the primitive document is reverently dedicated to the memory of the great unknown poet prophet, to whom both Judaism and Christianity are indebted for their first Bible.`, 
              authors:['An Unknown Genius of the Ninth Century, B.C'] ,  description:'', url:'/books/history/bookofyahwehthey00mans.pdf', copyright:'1922' },
    { id: 3, category:'history', type:'book', title: "THE LAST OF THE TASMANIANS.", subtitle:'The Black War of Dan Diemans Land',  relevance:'Europe meets Australia and... well...',   authors:['James Bonwick'] ,  description:'', url:'/books/history/europeancolonization/lasttasmanianso_jamesbonwick.pdf'}, 
    { id: 30, category:'history', type:'book', title: "History of Tasmania", subtitle:'',  relevance:'Europe meets Australia and... well...',   authors:['Truth Magazine'] ,  description:'', url:'/books/history/europeancolonization/historyoftasmania.pdf'}, 
    ...
    { id: 14, subcategory:'', category:'civics', type:'book', title: "Cooperative Federalism", subtitle:'',  relevance:'',   authors:['Gerald Brown, Ed.D'] ,  description:'', url:'/books/civics/Cooperative_Federalism.pdf'}, 
