...
//  https://eada.lib.umd.edu/ https://press-pubs.uchicago.edu/founders/
 ...
 export const references = [
    ...
    {id:26, subcategory:'repository', subcategory :CATEGORY_HISTORY ,type:'TYPE_WEBSITE', title:'The Founder\'s Convention', subtitle:'',iconurl:'',relevance:'primary sources', authors:'Philip B. Kurland and Ralph Lerner ', url:'https://press-pubs.uchicago.edu/founders/'},
  ];
