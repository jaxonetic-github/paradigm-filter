...
export const NO_PHOTO_AVAILABLE_URI =
  'https://static.wixstatic.com/media/84428b_aec5877604ff494295b3af5af0b27a67~mv2.png';
...
export const COMMON_EMPTY = unknownVariable =>
  unknownVariable == '' ||
  unknownVariable == [] ||
  unknownVariable == {} ||
...
export const WEBVIEW_CONNECTION_ERROR =
  'Unable to display WebView, please check your internet connection';
...
export const categories = [
  {key: '1', title: CATEGORY_HISTORY, description: ''},
  {key: '2', title: CATEGORY_ECONOMICS, description: ''},
  {key: '3', title: CATEGORY_PSYCHOLOGY, description: ''},
  {key: '4', title: CATEGORY_OCCULT, description: ''},
  {key: '5', title: CATEGORY_MOVER, description: ''},
];
...
export const COMMON_VIEWBUTTON_STYLES = {
  customOuterStyle: {
  ...
  buttonOuterShell: {borderWidth: 2, borderRadius: 15, backgroundColor: 'pink'},
  buttonTextShell: {
    borderWidth: 3,
    borderRadius: 10,
    backgroundColor: 'maroon',
...
/*export const commonViewButton = (buttonText, buttonPressAction) => (
  <View style={COMMON_VIEWBUTTON_STYLES.customOuterStyle}>
    <View style={COMMON_VIEWBUTTON_STYLES.buttonOuterShell}>
      <TouchableOpacity
        role
        onPress={buttonPressAction || null}
        style={COMMON_VIEWBUTTON_STYLES.buttonTextShell}>
...
export const random = seed =>
  Math.floor(Math.random() * Math.floor(seed ? seed : RANDOM_NUMBER_SEED));
...
export const SUBCATEGORY_LIST = [
  {label: 'Mental Slavery', value: 'Mental Slavery'},
  {label: 'War', value: 'War'},
...
const books = [
  {
    author: 'Druscilla Houson',
    title: 'Wonderful Ethiopians of the Ancient Cushite Empire',
  },
...
export const getDefaultProfile = eventProfile => {
  ...
  profile.name = eventProfile
    ? eventProfile.name
    : `Default Name_${profile.id}`;
  return profile;
};
