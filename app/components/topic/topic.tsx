...
import {nzingaProfileRecord,  NO_PHOTO_ALTERNATIVE_URI, tableColumns,citationColumns,references,ProfileReferencesTable} from './../../src/constants/references.js';
...
export default function TopicHome() {
        ...
        <div className='mx-5'>
          ...
          <p className='my-2  indent-12'>In the heirarchy of "rights", divine rights sit at the top without equal. 
           They are the same rights given by the "Creator" when the Creator "created" the divine laws of existence.
             These <ReferencePopover/>  like "cause and effect" are  axiomatic for theist, athiests, and everyone in between.
  ...
  <dd>
      <div className='bg-[#eee] w-[80%]'>
        ...
        <ul list-disc marker:text-sky-400>
      ...
      <ReferencesTable columns={citationColumns} rows={[references[9]]}/>
    </dd>
    <dd>
       <div className='bg-[#eee] w-[80%]'>
        <p className='my-2  indent-12'>
