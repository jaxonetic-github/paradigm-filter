...
import {Image} from "@heroui/react";
 ...
 const specificallyCompiledVideos={"Money Matters":_moneyAndBankingArray, 'Civics': _civicsFundamentalsArray};
...
export default function Home() {
  ...
  const navSetter = (newViewRecord:any)=>{setNavIndex(newViewRecord)};
