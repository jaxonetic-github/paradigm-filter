...
import CustomDialog from './../../../../_utils/CustomDialog.tsx'
 ...
 export default function money() {
  ...
  return (<div className='mx-5'>
       Different concepts of banking <Link underline="always" isExternal showAnchorIcon href='https://vocal.media/history/igudar-morocco-s-ancient-banking-system-and-the-story-of-communal-trust'>The First Banking System </Link>
