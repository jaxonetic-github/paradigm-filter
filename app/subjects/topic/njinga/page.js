...
import Njinga from '@/components/subjects/media/honorableMentionVideos.js';
...
/***
  ...
  <div className="md:flex">
   ...
   <Accordion variant="shadow">
     ...
     <ReferencesView columns={tableColumns} 
                          rows={profileRecord.sources.map((referenceIndex)=>references[referenceIndex])} />
      </AccordionItem>
