...
import Blackness from '@/components/subjects/civics/blackandwhite/blackness.js';
import Whiteness from '@/components/subjects/civics/blackandwhite/whiteness.js';
import Greyness from '@/components/subjects/civics/blackandwhite/greyness.js';
...
export default function Colorisms(){
 ...
 const kurimeo_evidenseofblack_snippet = {src:'Africans and Native Americans',
  ...
  <AccordionView title="Colored Peoples">
...
<div className='my-2 '>
  ...
  <AccordionView title="Recommended Race Resources">
